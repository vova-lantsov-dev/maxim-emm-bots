...
using MaximEmm.Shared;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Logging;
using Microsoft.Extensions.Options;
using MongoDB.Driver;

namespace MaximEmm.Bots
{
    internal sealed class ReviewBotWorker
    {
        private readonly ILogger<ReviewBotWorker> _logger;
        private readonly IOptionsMonitor<ReviewBotOptions> _optionsMonitor;
        private readonly BotsDatabaseContext _context;
        private readonly ITelegramBotClient _client;
        private readonly CultureService<> _cultureService;
        private readonly IHostEnvironment _env;

        private ReviewBotOptions Options => _optionsMonitor.CurrentValue;

        public ReviewBotWorker(IOptionsMonitor<ReviewBotOptions> optionsMonitor,
            ILogger<ReviewBotWorker> logger,
            BotsDatabaseContext context,
